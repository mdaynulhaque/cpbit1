...
(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        $("#slideslow-bg").vegas({
            ...
            slides: [
                {
                    src:  '/assets/user/assets/img/slider-img/slider-img-1.jpg'
                },
                {
                    src: '/assets/user/assets/img/slider-img/slider-img-2.jpg'
                },
                {
                    src: '/assets/user/assets/img/slider-img/slider-img-3.jpg'
                },
                {
                    src: '/assets/user/assets/img/slider-img/slider-img-4.jpg'
                }
            ]
        }); //Home Page Two Slideshow
