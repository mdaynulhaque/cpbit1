...
<body class="loader-active">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 bordered imagelogo">
                        <a href="{{ route('booking.dashboard') }}" class="logo">
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                <li class=""><a href="{{ route('booking.dashboard') }}">Home</a>
                                </li>
                                <li ><a href="{{ route('booking.dashboard') }}"> <img class="rounded-circle" src="{{ asset('/assets/user/assets/img/team/team-mem-1.png') }}" alt="JSOFT" height="30" width="30" style="padding: 2px; border:3px solid white;"></a>
                                     <ul>
                                ...
                                <li><a href="{{ route('room.view') }}">History</a></li><li><a href="{{ route('room.view') }}">Room List</a></li>
 ...
 {{-- @yield('page-js1') --}}
    ...
    <div class="scroll-top">
        <img src="{{ asset('/assets/user/assets/img/scroll-top.png') }}" alt="JSOFT" height="40" width="40">
    </div>
    <!--== Scroll Top Area End ==-->
