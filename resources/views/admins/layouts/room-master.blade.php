        ...
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
              <li class=""><a href="{{route('room.dashboard')}}"><i class="fa fa-dashboard"></i><span data-i18n="" class="menu-title">Dashboard</a>
             ...
             <li class="has-sub nav-item"><a href="#"><i class="text-info ft-home"></i><span data-i18n="" class="menu-title">Room Section</span></a>
                <ul class="menu-content">
                  <li class=""><a href="{{route('room.show')}}" class="menu-item">Room Section</a>
                  </li>
             </ul>
             </li>
             <li class=""><a href="{{route('booking.report')}}"><i class="text-danger fa fa-camera"></i><span data-i18n="" class="menu-title">Report</span></a>
             </li> 

             <li class=""><a href="{{route('booking.celendar')}}"><i class=" text-warning fa fa-calendar "></i><span data-i18n="" class="menu-title">Celendar View</span></a>
             </li>

              <li class=""><a href="{{route('holiday')}}"><i class="text-info fa fa-home "></i><span data-i18n="" class="menu-title">Anual Leave</span></a>
             </li>
          </div>
        </div>
            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
              <ul class="navbar-nav">
                ...
                <li class="dropdown nav-item"><a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle">
                  <img src="{{ asset('/assets/admin/app-assets/img/cpbit.png') }}" height="50" width="50"  style="margin-top: -12px" />
                  {{-- <i class="ft-user font-medium-3 blue-grey darken-4"></i> --}}
                    <p class="d-none">User Settings</p></a>
                  <div ngbdropdownmenu="" aria-labelledby="dropdownBasic3" class="dropdown-menu text-left dropdown-menu-right"><a href="../../../html/html/ltr/user-profile-page.html" class="dropdown-item py-1"><i class="ft-edit mr-2"></i><span>Edit Profile</span></a><a href="../../../html/html/ltr/inbox.html" class="dropdown-item py-1"><i class="ft-mail mr-2"></i><span>My Inbox</span></a>
